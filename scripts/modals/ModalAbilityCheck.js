    ...
    function _submitForm(event) {
		...
		switch (action) {
			case "roll-advantage":
				...
				messageParts.push(game.i18n.format(`gg5e_mm.modal.ability_check.message.${skill ? "skill" : "no_skill"}.advantage`, {
					ability: game.i18n.format(`gg5e_mm.monster.common.ability.${ability}.name`),
					skill: game.i18n.format(`gg5e_mm.monster.common.skill.${skill}`)
				}));
				break;
			case "roll-disadvantage":
				rollParts.push("2d20kl");
				messageParts.push(game.i18n.format(`gg5e_mm.modal.ability_check.message.${skill ? "skill" : "no_skill"}.disadvantage`, {
					ability: game.i18n.format(`gg5e_mm.monster.common.ability.${ability}.name`),
					skill: game.i18n.format(`gg5e_mm.monster.common.skill.${skill}`)
				}));
				break;
			default: 
				rollParts.push("1d20");
				messageParts.push(game.i18n.format(`gg5e_mm.modal.ability_check.message.${skill ? "skill" : "no_skill"}.plain`, {
					ability: game.i18n.format(`gg5e_mm.monster.common.ability.${ability}.name`),
					skill: game.i18n.format(`gg5e_mm.monster.common.skill.${skill}`)
				}));
				break;
